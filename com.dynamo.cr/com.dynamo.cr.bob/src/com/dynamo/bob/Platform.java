...
public class Platform {
    ...
    public static final Platform Arm64Aurora    = new Platform(OS.OS_ID_LINUX,      "arm64",        true,    "aurora",  new String[] {""},               "",     "lib",  ".so",      new String[] {"aurora", "arm64-aurora"},   PlatformArchitectures.AuroraOS,     "arm64-aurora");
